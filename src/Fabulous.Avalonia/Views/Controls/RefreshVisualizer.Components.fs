...
type ComponentRefreshVisualizer =
    ...
    static member RefreshRequested =
        if not ComponentRefreshVisualizer._RefreshRequestedInit then
            Fabulous.AttributeDefinitionStore.SyncRoot.Enter()

            try
                if not ComponentRefreshVisualizer._RefreshRequestedInit then
                    ComponentRefreshVisualizer._RefreshRequested <-
                    ...
                    ComponentRefreshVisualizer._RefreshRequestedInit <- true
            finally
