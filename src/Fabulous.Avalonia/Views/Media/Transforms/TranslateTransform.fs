...
//            let s1 = TranslateTransform.X.WithValue(x)
//            let s2 = TranslateTransform.Y.WithValue(y)
//            let bundle = AttributesBundle(StackList.two(s1, s2), [||], [||])
//            WidgetBuilder<'msg, IFabTranslateTransform>(TranslateTransform.WidgetKey, &bundle)
